...
Rendering materials implementation.
...
Materials are the way \hyperlink{class_wasabi}{Wasabi} passes parameters to effects and their shaders. Materials provide a simple, convenient interface to assign textures and shader U\+BO variables to shaders.
