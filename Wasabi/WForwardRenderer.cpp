...
public:
	...
	virtual void Load() {
		...
		LoadCodeGLSL(
			...
			""
			"	vec4 mat1 = texelFetch(samplerAnimation, ivec2(baseU + 0, baseV), 0);\n"
			"	vec4 mat2 = texelFetch(samplerAnimation, ivec2(baseU + 1, baseV), 0);\n"
			"	vec4 mat3 = texelFetch(samplerAnimation, ivec2(baseU + 2, baseV), 0);\n"
			"	vec4 mat4 = vec4(mat1.w, mat2.w, mat3.w, 1.0f);\n"
			"	mat1.w = 0.0f;\n"
			"	mat2.w = 0.0f;\n"
			"	mat3.w = 0.0f;\n"
			"	mat4x4 m = mat4x4(1.0);\n"
