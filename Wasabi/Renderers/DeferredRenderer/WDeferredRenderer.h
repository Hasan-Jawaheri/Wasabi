...
class WDeferredRenderer : public WRenderer {
	...
	class GBufferStage {
		...
		/** Render target for front-faces render */
		class WRenderTarget* m_renderTarget;
		/** Render target for back-faces render */
		class WRenderTarget* m_backfaceRenderTarget;
		/** Depth attachment in the GBuffer */
		class WImage* m_depthTarget;
		/** Depth attachment in the GBuffer for backface render pass */
		class  WImage* m_backfaceDepthTarget;
		/** Color attachment in the GBuffer */
		class WImage* m_colorTarget;
		/** Normal attachment in the GBuffer */
		class WImage* m_normalTarget;
	...
	/** Effect used to render objects backfaces */
	class WEffect* m_backfaceFX;
	/** Sprite used to render the final composition */
	class WSprite* m_masterRenderSprite;
	/** Final composition material */
	class WMaterial* m_compositionMaterial;
	/** Texture of random bumps used in SSAO */
	class WImage* m_SSAORandomTexture;
