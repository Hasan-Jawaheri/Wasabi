...
function(build_dist TARGET_NAME WASABI_TARGET_NAME)
    ...
    if (MSVC)
        add_custom_command(
            ...
            COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:wasabi> "$<$<CONFIG:Debug>:${CMAKE_BINARY_DIR}/dist/lib/Debug/$<TARGET_FILE_NAME:${WASABI_TARGET_NAME}>>$<$<CONFIG:Release>:${CMAKE_BINARY_DIR}/dist/lib/Release/$<TARGET_FILE_NAME:${WASABI_TARGET_NAME}>>"
        ...
        add_custom_command(
            ...
            COMMAND ${CMAKE_COMMAND} -E copy_directory "${CMAKE_SOURCE_DIR}/include/Wasabi/" "${CMAKE_BINARY_DIR}/dist/include/Wasabi/"
            COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:wasabi> "${CMAKE_BINARY_DIR}/dist/lib/$<TARGET_FILE_NAME:${WASABI_TARGET_NAME}>"
            COMMENT "Building the dist/ folder"
        )
        add_custom_target(${TARGET_NAME}
